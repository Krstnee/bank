      ...
      <div className="about-project__dev">
        <h2 className="about-project__header">Что такое банкротство?</h2>
            <div className="aboutme__container">
                ...
                <p className="usefull__text1"><a className='usefull__link' href='https://www.consultant.ru/document/cons_doc_LAW_39331/15bac90772e695baab0ffa86106dfd11c02e7802/'><b>Согласно ст. 213.30 Закона о банкротстве</b></a></p>
                ...
                <p className="usefull__text1"><a className='usefull__link' href='https://www.consultant.ru/document/cons_doc_LAW_39331/172be73862055bd14886b44f702a4f7fceb7f94c/'><b>Согласно ст. 216 Закона о банкротстве</b></a></p>
                ...
                <p className=""><b>Условия (<a className='usefull__link' href='https://www.consultant.ru/document/cons_doc_LAW_39331/c2c8c81ee8e4bd843286b08b10607f00ec6ae073/'>Согласно ст. 213.4 Закона о банкротстве</a>)</b></p>
                ...
                <p className="usefull__text1"><a className='usefull__link' href='https://www.consultant.ru/document/cons_doc_LAW_39331/c48290d39215783e73f0899bb1026b14cb221eff/'><b>Согласно ст. 223.2 Закона о банкротстве</b></a></p>
                ...
                <li className="usefull_li">На день обращения <b className="text__termin" tooltip='Исполнительное производство — это механизм принудительного взыскания задолженности с неплательщика судебными приставами-исполнителями. Основанием для начала такого производства служит исполнительный документ — его суд выдает в том случае, если добровольно исполнять судебный акт и рассчитываться с кредиторами должник отказывается.'>исполнительное производство</b> завершили из-за отсутствия имущества для взыскания. Иных действующих производств (по истребованию денег), которые возбудили после того, как взыскателю вернули <b className="text__termin" tooltip='Исполнительное производство — это механизм принудительного взыскания задолженности с неплательщика судебными приставами-исполнителями. Основанием для начала такого производства служит исполнительный документ — его суд выдает в том случае, если добровольно исполнять судебный акт и рассчитываться с кредиторами должник отказывается.'>исполнительный документ</b>, тоже нет</li>
